...
. Click the *Add* icon (image:icon-blue-plus.png["",2.5%,2.5%]).
...
+
image::mq-tutorial-client-apps-detail.png["Client app name,  and the Copy and Show buttons for the selected client app"]
+
[calloutlist]
