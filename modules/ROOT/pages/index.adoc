...
. Set the Anypoint MQ Connector operation to publish or consume messages, or to accept (ACK) or not accept (NACK) a message. See xref:anypoint-mq-connector::index.adoc[Anypoint MQ Connector 4.x for Mule 4].
//
