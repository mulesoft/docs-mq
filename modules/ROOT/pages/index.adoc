...
Anypoint MQ is fully integrated with Anypoint Platform and provides the same management capabilities, including environments and business groups for role-based access control, access management, and support for connected apps.
...
* *Usage Statistics*
+
A chart that illustrates how much data and API requests you have used.
