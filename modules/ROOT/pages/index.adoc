...
. Click a queue or message exchange name in the detail to access the *Message Sender* page to send messages to a queue or message exchange, and to use the *Message Browser* to get messages from a queue.
