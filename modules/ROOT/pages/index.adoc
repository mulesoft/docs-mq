...
. Depending on your authentication method, configure a connected app to get an ID and secret to configure Anypoint Connector for MQ (Anypoint MQ Connector).
