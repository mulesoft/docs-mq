...
Usage Statistics::
+
View usage reports to manage peak usage and subscription parameters.
Reports provide current and past usage, including consumed data, API requests, and the total number of messages received.
+
For information, see xref:mq-usage.adoc[].
+
