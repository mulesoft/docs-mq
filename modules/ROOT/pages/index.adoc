...
. Depending on your authentication method, configure a Connected App or client app to get an ID and secret to configure Anypoint Connector for MQ (Anypoint MQ Connector).
...
. Configure Anypoint MQ Connector and provide the ID and secret of the app.
. Set the Anypoint MQ Connector operation to publish or consume messages, or to accept (ACK) or not accept (NACK) a message. See xref:connectors::anypoint-mq/4.x/anypoint-mq-connector.adoc[Anypoint MQ Connector 4.x for Mule 4].
//
