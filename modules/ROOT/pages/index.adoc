...
Anypoint MQ does not support use with CloudHub Insight or Anypoint Monitoring. Instead you can use the xref:mq-usage.adoc[Anypoint MQ usage graphs] to view consumed data and API requests and how many message units were received, or you can use the xref:mq-apis.html#mqstatapi[Anypoint MQ Stats API] to perform statistical analysis of queue performance.
...
+
The Anypoint MQ  sends the string as a message to the queue or message exchange you specified.
+
