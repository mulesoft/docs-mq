...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload in the details pane, (*3*) the *Return Messages* icon, (*4*) the *Delete* icon, (*5*) the *Full Screen* icon, and (*6*) the *Close* details pane icon.
...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload, (*3*) the *Return Messages* icon, (*4*) the *Delete* icon, (*5*) the *Full Screen* icon, and (*6*) the *Close* details pane icon.
image::mq-tutorial-msg-browser-payload-details-curl.png[Selected message row, payload, Return Messages icon, Delete icon, Full Screen icon, and Close details pane icon]
+
* Click *Full Screen* to display the message payload in a separate window or *Close* to close the details pane.
* Click *Delete* to delete the selected message.
...
. Click the message row to view the message payload in the details pane:
+
.The screenshot shows (*1*) the message row, (*2*) the message payload, (*3*) *Return Messages* icon, (*4*) *Delete* icon, (*5*) *Full Screen* icon, and (*6*) *Close* details pane icon.
image::mq-tutorial-msg-browser-payload-details-curl-rtm.png[Selected message row, payload, Return Messages icon, Delete icon, Full Screen icon, and Close details pane icon]
+
* Click *Full Screen* to display the message payload in a separate window or *Close* to close the details pane.
* Click *Delete* to delete the selected message.
* Click *Return Messages* to return the message to the queue (for example, to enable other applications to read the message). 
