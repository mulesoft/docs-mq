...
. Click *Send*.
. Set the *Type* to *CSV* and enter the following in the *Payload* field:
+
----
"dog",
"fish",
...
----
. Click *Send*.
. Set the *Type* to *JSON* and enter the following in the *Payload* field:
+
...
.. In the *Configure Connection* page in Design Center, paste the URL in the *URL* field.
