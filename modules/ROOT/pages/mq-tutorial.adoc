...
Before configuring an app in Design Center, leave a browser window open to *Anypoint Platform* > *MQ* so that you can access the queue and the client app ID and client secret values for the client app you registered previously.
