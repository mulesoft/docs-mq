...
+
image::mq-shared-create-choices.png["Blue plus icon menu options"]
. Select *Queue*.
...
* Create a Connected App and use the ID and secret to configure Anypoint MQ Connector. (Recommended)
* Create a client app and use the client ID and client secret use to configure Anypoint MQ Connector. 
