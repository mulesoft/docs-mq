...
. Click the *Add* icon (image:icon-blue-plus.png["Add icon in Destinations",2%,2%]) to display the menu:
+
...
. Click *HTTP Listener*.
. In the *HTTP Listener* window, set the value of *Path* to `/mq/{messageId}` and then click the *Close* icon (image:icon-ds-close.png["Close icon",2%,2%]):
+
...
. Click the *Add* icon (image:icon-ds-plus.png["Add icon",2%,2%]) for the HTTP Listener trigger:
+
...
. Click the *Close* icon (image:icon-ds-close.png["Close icon",2%,2%]) to close the *Publish Configuration* page:
+
image::mq-tutorial-dc-mq-close.png["Close icon"]
. Select *Deploy Application* from the image:icon-ds-v.png["V icon",2%,2%] menu: 
+
...
. Click the *Add* icon (image:icon-green-plus.png["Add icon in Studio",2%,2%]) for the *Connector configuration* field.
...
. Click the *Add* icon (image:icon-green-plus.png["Add icon in Studio",2%,2%]) for the *Connector configuration* field to display the *Global Element Properties* window.
...
. Click the HTTP connector and click the *Add* icon (image:icon-green-plus.png["Add icon in Studio",2%,2%]) for *Connector Configuration*.
...
. In the Anypoint MQ properties window, click the *Add* icon (image:icon-green-plus.png["Add icon in Studio",2%,2%]) for *Connector Configuration*.
