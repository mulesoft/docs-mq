...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload in the details pane, (*3*) the *Return Messages* icon, (*4*) the trash can icon, and (*5*) the *Full Screen* icon.
...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload, and (*3*) *Full Screen* icon in the details pane.
...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload, and (*3*) *Full Screen* icon in the details pane.
image::mq-tutorial-msg-browser-payload-details-curl-rtm.png[Selected message row, payload, and Full Screen icon in the details pane]
. Click the *Full Screen* icon to display the message payload in a separate window.
. Try changing the body text in the `curl` command and repeat the steps to view the message.
