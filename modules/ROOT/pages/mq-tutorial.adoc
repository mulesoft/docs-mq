...
+
image::mq-switch-env.png["Environment button on the Destinations page"]
. Click *Destinations*:
+
...
+
image::mq-tutorial-msgs-in-queue.png["Details pane with three messages in the myDemoQueue queue"]
...
Click *Configuration XML* tab in Studio and compare your XML to this example.
