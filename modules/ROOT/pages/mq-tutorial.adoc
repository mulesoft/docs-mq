...
. Click the *Add* icon (image:icon-green-plus.png["",2.5%,2.5%]) for the *Connector configuration* field.
...
. Click the *Add* icon (image:icon-green-plus.png["",2.5%,2.5%]) for the *Connector configuration* field to display the *Global Element Properties* window.
