...
IMPORTANT: When publishing to FIFO queues, if you specify a custom Message ID and the Message ID is the same on multiple messages, messages containing the same Message IDs are discarded.
