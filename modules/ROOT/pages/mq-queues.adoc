...
* Using `prefetch` mode with FIFO queues is not recommended.
+
For information, see xref:anypoint-mq-connector::anypoint-mq-listener.adoc#fifo-and-prefetch[FIFO Queues and Prefetch Mode]
