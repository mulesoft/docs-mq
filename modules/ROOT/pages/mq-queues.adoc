...
You can recover messages from the DLQ using the REST API to get the message from the queue and writing the message to a new queue. See xref:mq-apis.adoc#mq-admin-api[Anypoint MQ Admin API].
