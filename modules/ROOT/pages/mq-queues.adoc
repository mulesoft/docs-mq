...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload in the details pane, (*3*) the *Return Messages* icon, and (*4*) the *Full Screen* icon.
image::mq-msg-browser-payload-details.png[Selected message row, payload in the details pane, and *Return Messages* and *Full Screen* icons]
+
...
+
.The arrow shows (*1*) the *Message Browser* option and (*2*) the *User Properties* in the details pane.
...
Alternatively, you can delete the message by clicking the *Delete* icon in the details pane:

.The arrow shows the *Delete* icon in the details pane for deleting a message in the queue.
image::mq-msg-browser-delete-icon.png[Delete icon for deleting a message in the queue]
...
. Click the message row to view the message payload in the details pane:
+
.The screenshot shows (*1*) the message row, (*2*) the message payload in the details pane, (*3*) *Return Messages* icon, (*4*) *Delete* icon, (*5*) *Full Screen* icon, and (*6*) *Close* details pane icon.
image::mq-msg-browser-payload-details-json.png[Selected message row, payload, Return Messages icon, Delete icon, Full Screen icon, and Close details pane icon]
+
...
+
.The screenshot shows (*1*) the message row, (*2*) the message payload in the details pane, (*3*) the *Return Messages* icon, and (*4*) the *Full Screen* icon.
image::mq-msg-browser-payload-details-csv.png[Selected message row, CSV payload in the details pane, and *Return Messages* and *Full Screen* icons]
. Click the *Full Screen* icon to display the message payload in a separate window.
...
. In *Anypoint Platform > MQ*, click *Destinations* in the left pane.
. Click the queue type for the queue to display its details in the right pane.
. Click the *Delete* can icon in the details pane:
+
