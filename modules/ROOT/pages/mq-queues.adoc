...
image::mq-msg-browser-payload-details.png[Selected message row, payload, Return Messages icon, Delete icon, Full Screen icon, and Close details pane icon]
+
* Click *Full Screen* to display the message payload in a separate window.
* Click *Close* to close the details pane.
...
. Click the message row to view the message payload in the details pane:
+
.The screenshot shows the JSON message payload, (*1*) the *Full Screen* icon, and (*2*) the *Close* details pane icon.
...
. Click the message row to view the message payload in the details pane:
+
.The screenshot shows the CSV message payload, (*1*) the *Full Screen* icon, and (*2*) the *Close* details pane icon.
image::mq-msg-browser-payload-details-csv.png[CSV payload, Full Screen icon, and Close icon details pane icon]
+
Click *Full Screen* to display the message payload in a separate window or *Close* to close the details pane.
