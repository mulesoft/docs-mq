...
image::mq-filters.png["Destinations page with filter options for message queue destinations"]
...
+
image::mq-tutorial-msgs-in-queue.png["The number of messages in the queue in the details pane"]
// I think this screenshot is OK.
