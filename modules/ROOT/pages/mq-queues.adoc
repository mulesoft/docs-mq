...
+
If user properties are configured in the *Message Sender* page or Publish operation in Anypoint MQ Connector, they appear in the details pane for the message:
