...
When the connector determines that the primary region is available again,
it switches back to the primary region.
...
You can disable failover, but you cannot delete the fallback queue in the Anypoint MQ.
