...
* Upgrade Anypoint MQ Connector to one of the following versions:
+
** xref:anypoint-mq-connector::index.adoc[Anypoint MQ Connector 4.0.5] or later
** xref:connectors::anypoint-mq/3.x/anypoint-mq-connector.adoc[Anypoint MQ Connector 3.2.6] or later
