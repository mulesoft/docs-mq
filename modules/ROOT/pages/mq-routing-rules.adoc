...
image::mq-route-message.png["Rules on exchange bindings routing messages to specific queues"]
...
+
If you publish this message to the `purchases` exchange,
...
+
image::mq-exchange-add-rule-bound-queues.png["Exchange Settings page showing the Add Rule button"]
. Complete the fields on the *Create Routing Rule* page.
+
image::mq-exchange-create-routing-rule.png["Create Routing Rule form showing example values"]
+
...
+
image::mq-exchange-edit-rule-bound-queues.png["Exchange Settings page showing the Edit Rule button"]
...
+
image::mq-exchange-delete-rule-bound-queues.png["Exchange Settings page showing the Delete Rule button"]
...
+
image::mq-exchange-user-props.png["Message Browser details page showing the message payload and user properties"]
+
See
...
* Exchanges must have 25 or fewer queue bindings.
+
