...
You can view how much data and how many API requests have been consumed, and how many message units were received.
...
[NOTE]
include::partial$mq-api-shared.adoc[tag=mqFeaturesNoHFnote]
...
[NOTE]
include::partial$mq-api-shared.adoc[tag=mqFeaturesOnlyHFnote]
...
+
The report shows usage for the selected period:
+
* Total Message units
* Total Message bytes
* Total API requests
