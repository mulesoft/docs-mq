...
You access Anypoint MQ usage data in Usage.
...
+
NOTE: Usage information for hourly, daily, and monthly billing usage information might be delayed by up to three hours.
.. Subscription type
+
...
+
This permission enables you to view reports in xref:general::usage-reports.adoc[Usage].
