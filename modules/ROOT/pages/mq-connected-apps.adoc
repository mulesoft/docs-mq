...
When you create a connected app, Access Management lists the client ID and client secret for the app.
...
+
Use the client ID and client secret to get the access token required to authenticate with the Anypoint MQ API.

. When you configure Anypoint MQ Connector in your Mule app, paste the client ID and client secret values in the *Anypoint MQ Config* window in Studio:
+
