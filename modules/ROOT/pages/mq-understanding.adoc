...
* If a consumer processes a message successfully, the client acknowledges the message, and MQ removes the message from the queue. For more information on how Anypoint MQ processes acknowledged messages, see xref:mq-ack-mode.adoc[Acknowledge Mode].
...
* Ack/Nack: Ack - An application receives a message and MQ deletes the message. For more information, see xref:mq-ack-mode.adoc[Acknowledgement Mode].
