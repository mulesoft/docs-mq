...
** xref:mq-apis.adoc#mqbrokerapi[Anypoint MQ Broker API] enables clients to publish, consume, route, and acknowledge messages from queues and message exchanges.
