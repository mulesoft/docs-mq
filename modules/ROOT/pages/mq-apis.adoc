...
Before submitting an API access, you need to acquire an access token:

* <<mqadminapi,MQ Admin API>> - Get an access token for the Anypoint Platform user.
...
* <<mqstatapi,MQ Stats API>> - Get an access token for the Anypoint Platform user.
