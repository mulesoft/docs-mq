...
The response from the Stats API includes 60 seconds of inconsistency due to internal post-processing activities.
...
Post-processing activities when message statuses change (to in-flight, from in-flight, and to deleted) also result in up to 60 seconds of inconsistency.
