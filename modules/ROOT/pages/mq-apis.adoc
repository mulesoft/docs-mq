...
----
+
See the https://docs.mulesoft.com/mq/[Anypoint MQ starting page] for the regions that MQ and FIFO are available in.
+
...
See the https://docs.mulesoft.com/mq/[Anypoint MQ starting page] for the regions MQ and FIFO are available in.
...
*Note:* The organization from which you use the Administration portal must have an Anypoint MQ FIFO entitlement. See https://docs.mulesoft.com/mq/[Anypoint MQ] for the regions MQ is available in.
