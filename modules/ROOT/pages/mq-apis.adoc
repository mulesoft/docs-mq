...
See the xref:mq-faq.adoc#regions[MQ FAQ] for the regions where Anypoint MQ and FIFO are available.
...
[NOTE]
Anypoint MQ limits retrieving stats by organization to 10 transactions per minute, per organization.
