...
[source,bash]
----
curl -X GET "https://anypoint.mulesoft.com/mq/stats/api/v1/organizations/ORGANIZATION_ID?startDate=Tuesday%2C%201%20Aug%202023%2000%3A00%3A00%20GMT&endDate=Thursday%2C%203%20Aug%202023%2023%3A59%3A59%20GMT&period=1day" \
-H "Authorization: bearer BEARER_TOKEN" \
-H "Cache-Control: no-cache"
----
