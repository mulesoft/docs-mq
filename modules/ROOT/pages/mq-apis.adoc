...
=== Use the Anypoint MQ Admin API


NOTE: To access the Anypoint MQ Admin API, you must first authenticate using the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/access-management-api/[Anypoint Access Management API].
...
You can use the Admin API to create these message routing rules.

The following `curl` command creates a message routing rule:

[source,console,linenums]
----
curl "https://anypoint.mulesoft.com/mq/admin/api/v1/organizations/ORGANIZATION_ID/environments/ENVIRONMENT_ID/regions/REGION_ID/bindings/exchanges/purchases/queues/premiumPurchases/routingRules" \
  -X PUT \
...
To change an existing routing rule, submit another `PUT` with the new message routing rule configuration.

[NOTE]
Any changes or additions to a message routing rule can take up to 15 minutes to take effect.

For information on the supported properties and attributes for `routingRules`,
see this endpoint in the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/anypoint-mq-admin/[Anypoint MQ Admin API]:

[source]
/organizations/ORGANIZATION_ID/environments/ENVIRONMENT_ID/regions/REGION_ID/bindings/exchanges/EXCHANGE_ID/queues/QUEUE_ID/routingRules

For information about the message routing rule limitations, see
xref:mq-routing-rules.adoc#intelligent-routing-limitations[Limitations].
...
The  
https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/anypoint-mq-broker/[Anypoint MQ Broker API] enables clients to publish, retrieve, and acknowledge messages from queues and message exchanges.
...
[[excoliuscu]]
=== Use the Anypoint MQ Broker API
...
property as `premium`.
The rule on the `purchases` exchange binding 
...
For information about the message filtering limitations, see
xref:mq-routing-rules.adoc#intelligent-routing-limitations[Limitations].
...
-H "Cache-Control: no-cache" \
-H "Postman-Token: 42544254-4254-4254-4254-425442544254" \
"https://mq-us-east-1.anypoint.mulesoft.com/api/v1/organizations/42544254-4254-4254-4254-425442544254/environments/42544254-4254-4254-4254-425442544254/destinations/postmanQueue/messages?pollingTime=10000&batchSize=1&lockTtl=10000&payloadVisibility=conditional"
----
...
?startDate=Thursday, 8 Nov 2021 04:49:37 GMT
&endDate=Sun, 11 Nov 2021 04:60:44 GMT
&period=1day
...
The Stats API can be used to retrieve Anypoint MQ usage for the root business organization:
