...
* <<mqbrokerapi,Anypoint MQ Broker API>> - Get a token from Anypoint MQ by supplying the client ID and client secret for an MQ app.
...
See the xref:mq-faq.adoc[MQ FAQ] for the regions in which Anypoint MQ and FIFO queues are available.
...
This sections summarizes the steps.
