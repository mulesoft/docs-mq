...
[%collapsible]
====
Response includes `"isFallback" : false` and doesn't include `fallbackConfig`.
...
However, it does not get updated in real-time, and there is an approximate latency of 5 to 10 minutes before data is published. The retention period of historical data is 15 months.
