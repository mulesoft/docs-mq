...
Client apps can send up to 50 transactions per minute (TPM) to Anypoint MQ Admin API endpoints.
If you call the Anypoint MQ Admin API for an environment multiple times within a short amount of time, the API throttles your requests to 50 TPM.
