...
:page-notice-banner-message: The limits described under xref:mq-apis.adoc#usage-limits[Usage Metrics Limits] aren't enforced yet. We recommend taking appropriate action to adapt.
