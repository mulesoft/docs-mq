...
* <<routing-rules-api>>
* <<enable-failover-api>>
* <<get-failover-queues-api>>
* <<get-failover-pairs-api>>
...
WE NEED CURL COMMANDS/EXAMPLES HERE!
...
[source,bash]
----
curl -X PUT "https://mq-us-east-1.anypoint.mulesoft.com/api/v1/organizations/ORGANIZATION_ID/environments/ENVIRONMENT_ID/regions/REGION_URL/queues/QUEUE_ID/fallback" \
...
[[get-failover-queues-api]]
=== Get List of Standard Queues With Failover Enabled

Use this `curl` command to return a list of all standard queues with failover configured:

[source,bash]
----
curl -X GET "https://mq-us-east-1.anypoint.mulesoft.com/api/v1/organizations/ORGANIZATION_ID/environments/ENVIRONMENT_ID/regions/REGION_URL/destinations?inclusion=MINIMAL" \

----

Use this `curl` command to return a single queue with failover configured:

[source,bash]
----
curl -X GET "https://mq-us-east-1.anypoint.mulesoft.com/api/v1/organizations/ORGANIZATION_ID/environments/ENVIRONMENT_ID/regions/REGION_URL/???????" \

----

[[get-failover-pairs-api]]
=== Get List of Primary-Fallback Queue Pairs

The following `curl` command returns a list of primary-fallback queue pairs:
