...
:page-notice-banner-message: The limits described under <a href="https://docs.mulesoft.com/mq/mq-apis#usage-limits" target="_blank" rel="noopener">Usage Metrics Limits</a> aren't enforced yet. We recommend taking appropriate action to adapt. See <a href="https://help.salesforce.com/s/articleView?id=004754267&type=1" target="_blank" rel="noopener">Changes to MQ and Object Store v2 Statistics API</a>. For information about Anypoint MQ Stats API rate limits, refer to the <a href="https://docs.mulesoft.com/mq/mq-apis#mq-stats-api" target="_blank" rel="noopener">Anypoint MQ Stats API</a> documentation.
