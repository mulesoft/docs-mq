...
The *Message Browser* page displays the payload only if the payload size is smaller that 1 MB.
...
See xref:mq:mq-apis.adoc#example-retrieve-a-message[Example: Retrieve a Message].
