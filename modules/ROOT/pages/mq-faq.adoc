...
----
<anypoint-mq:consume doc:name="Consume" doc:id="3ff7a169-f3c9-4e93-ab02-9db178cd6e32" config-ref="Anypoint_MQ_Default_subscriber" destination="/mq/{messageId}" />
		<logger level="INFO" doc:name="Logger" doc:id="36fdd310-c7a8-4f3c-b844-adc8ca06d349" />
