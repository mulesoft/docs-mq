...
Anypoint Broker API doesn't guarantee the number of messages retrieved in a single call.
For more information, see <<batchsize,Why do I receive fewer messages than my batch size when retrieving messages with the Anypoint MQ REST API?>>.
