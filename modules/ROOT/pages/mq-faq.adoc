...
Anypoint MQ supports up to 120,000 in-flight messages per each standard (non-FIFO) queue. FIFO queues allow up to 10 in-flight messages per message group due to the extra processing required for FIFO queues.
