...
Anypoint MQ uses in-flight HTTPS encryption with Transport Layer Security (TLS) 1.2 protocols to transport messages and doesn't support the deprecated TLS versions 1.0 and 1.1.
//Shared Encryption
