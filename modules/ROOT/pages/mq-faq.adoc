...
Additionally, if your Anypoint MQ queues are configured for encryption at rest, then the payloads are encrypted server-side using the native encryption algorithm provided by the CloudHub infrastructure security settings.
