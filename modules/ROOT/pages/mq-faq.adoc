...
messages; however the number of in-flight messages is limited. The maximum duration for any message, either in-flight or not is 2 weeks, after which Anypoint MQ deletes the message.
