...
The FIFO restriction is because the FIFO queues are limited to 10 in-flight messages per message group. For more information on in-flight messages, see <<inflights,How many in-flight messages can I have per queue?>>
