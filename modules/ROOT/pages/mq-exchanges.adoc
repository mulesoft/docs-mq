...
A _message exchange_ binds one or more standard 
xref:mq-queues.adoc[queues] so that a message sent to a message exchange appears in all the bound queues simultaneously.
