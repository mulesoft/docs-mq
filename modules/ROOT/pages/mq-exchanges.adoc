...
+
.The screen shows (*1*) the checkboxes to select multiple queues, (*2*) the *Unbind* and (*3*) *Bind* buttons to unbind or bind a single queue to the exchange.  
image::mq-bind-queue-to-exchange2.png[Checkboxes for multiple select, Unbind, and Bind buttons]
+
...
+
.The arrow shows the trash can icon in the details pane for deleting an exchange.
image::mq-exchange-delete.png[Trash can icon in the details pane for deleting an exchange]
. In the Delete Exchange page, click the checkbox, and then click *Delete Exchange*:
+
