...
+
image::mq-exchange-bind-queues.png["Checkboxes to bind queues to an exchange in the Create Exchange page"]
. Click *Save Changes*.
...
+
image::mq-exchange-details-pane.png["Destinations page showing the exchange type and the bound queues in the details pane"]
