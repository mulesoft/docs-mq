...
Using a _message exchange_ you can send a message to one or more xref:mq-queues.adoc[queues] that are bound to the message exchange. The maximum size of a message sent to a message exchange is 10 MB.
