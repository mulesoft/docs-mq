...
You can set a local state using the Anypoint MQ connector's *Operation* dropdown:

image::mq-connector-ops.png["Operation dropdown in Anypoint Studio"]
...
image::mq-ack-flow.png["MQ acknowledgment mode flows in Anypoint Studio"]
...
image::mq-global-mode-set.png["Acknowledgment Mode dropdown in Anypoint Studio"]
...
image::mq-manual-flow.png["Manual acknowledgment mode flow in Anypoint Studio"]
...
image::mq-global-mode-set.png["No acknowledgment mode flow in Anypoint Studio"]
