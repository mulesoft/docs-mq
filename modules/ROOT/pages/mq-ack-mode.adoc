...
IMPORTANT: This guide applies only to Mule 3 and Studio 6. For Mule 4 acknowledge information, see xref:connectors::anypoint-mq/4.x/anypoint-mq-ack.adoc[ACK and NACK Operations].
